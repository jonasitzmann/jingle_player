from config import Config, MockingConfig, CalendarConfig, JingleConfig, Jingle, timedelta

mocking = MockingConfig.mock_nothing()  # debugging options (e.g. simulate time, don't play sound, don't access spotify)
mocking.begin_before_1st_job = timedelta(seconds=5)
mocking = MockingConfig.mock_everything()
